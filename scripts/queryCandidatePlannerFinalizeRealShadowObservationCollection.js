...
async function main() {
  ...
  if (!fs.existsSync(windowPath)) throw new Error("OBSERVATION_COLLECTION_WINDOW_REQUIRED");
  ...
  try {
    ...
    console.log("PASS patch 15.3.2-E real shadow observation collection finalized");
